...
{
printf("\nIngrese nombre: ");
scanf("%s",(pArrayPersona+logitudPersonas-1)->nombre); //No usamos & porque "nombre" es un vector.
printf("\nIngrese edad: ");
scanf("%d",&((pArrayPersona+logitudPersonas-1)->edad)); //Usamos & porque "edad" no es un vector.
